...
//  solarSystemARKit
//
//  Created by Furkan Cemal Çalışkan on 22.09.2022.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let mars = createSphere(radius: 0.1, content: "mars.png", vector: SCNVector3(0, 0.5, -1))
        let venus = createSphere(radius: 0.1, content: "venus.png", vector: SCNVector3(1, 0.2, -1))
