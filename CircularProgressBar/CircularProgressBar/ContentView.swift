...
struct ContentView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            Circular(lineWidth: 40, backgroundColor: Color.red.opacity(0.2), foregroundColor: Color.red, percentage: firstCirclePercentage)
            ...
            Circular(lineWidth: 40, backgroundColor: Color.blue.opacity(0.2), foregroundColor: Color.blue, percentage: thirdCirclePercentage)
